...
Route::get('paket', [\App\Http\Controllers\HomeController::class, 'paket'])->name('paket.index');

Route::get('paket/{paket:id}', [\App\Http\Controllers\HomeController::class, 'paketshow'])->name('paket.show');

Route::get('inap/{penginapan:id}', [\App\Http\Controllers\HomeController::class, 'penginapanshow'])->name('inap.show');
