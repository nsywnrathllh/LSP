...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/style.css') }}" />
     ...
     <!--Logo Title Bar-->
     <link rel="icon" href="vendor\adminlte\dist\img\logo.png" type="image/x-icon">
        ...
        <nav class="nav container">
            ...
            <div class="nav__menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        <a href="{{ route('paket.index') }}" class="nav__link {{ request()->is('paket') || request()->is('paket/*')  ? ' active-link' : '' }}">
            ...
            {{-- <a target="_blank" href="{{  route('reservasi')  }}" class="button nav__button">Booking Now</a> --}}
    ...
    <footer class="footer section" id="contact">
        ...
        <div class="footer__info container">
            <span class="footer__copy">
                &#169; JourneyWise. All rigths reserved
            </span>
